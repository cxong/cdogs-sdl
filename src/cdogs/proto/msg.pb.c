...
const pb_field_t NObjectiveCount_fields[3] = {
    PB_FIELD(  1, INT32   , REQUIRED, STATIC  , FIRST, NObjectiveCount, ObjectiveId, ObjectiveId, 0),
    PB_FIELD(  2, INT32   , REQUIRED, STATIC  , OTHER, NObjectiveCount, Count, ObjectiveId, 0),
    PB_LAST_FIELD
};
...
const pb_field_t NAddPickup_fields[7] = {
    PB_FIELD(  1, INT32   , REQUIRED, STATIC  , FIRST, NAddPickup, UID, UID, 0),
    ...
    PB_FIELD(  5, INT32   , REQUIRED, STATIC  , OTHER, NAddPickup, TileItemFlags, SpawnerUID, 0),
...
const pb_field_t NObjectiveUpdate_fields[3] = {
    PB_FIELD(  1, INT32   , REQUIRED, STATIC  , FIRST, NObjectiveUpdate, ObjectiveId, ObjectiveId, 0),
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(NPlayerData, Looks) < 65536 && pb_membersize(NActorAdd, FullPos) < 65536 && pb_membersize(NActorMove, Pos) < 65536 && pb_membersize(NAddPickup, Pos) < 65536 && pb_membersize(NAddBullet, MuzzlePos) < 65536 && pb_membersize(NExploreTile, Tile) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_NRequestPlayers_NCmd_NNewPlayers_NClientId_NCampaignDef_NPlayerData_NPlayerData_CharLooks_NObjectiveCount_NAddPlayers_NScore_NVec2i_NActorAdd_NActorMove_NActorState_NActorDir_NAddPickup_NAddBullet_NExploreTile_NObjectiveUpdate)
#endif
