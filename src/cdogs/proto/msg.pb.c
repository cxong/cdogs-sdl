...
const pb_field_t NPlayerData_fields[12] = {
    ...
    PB_FIELD(  3, STRING  , REQUIRED, STATIC  , OTHER, NPlayerData, Hair, CharacterClass, 0),
    PB_FIELD(  4, MESSAGE , REQUIRED, STATIC  , OTHER, NPlayerData, Colors, Hair, &NCharColors_fields),
    PB_FIELD(  5, STRING  , REPEATED, STATIC  , OTHER, NPlayerData, Weapons, Colors, 0),
    PB_FIELD(  6, UINT32  , REQUIRED, STATIC  , OTHER, NPlayerData, Lives, Weapons, 0),
    PB_FIELD(  7, MESSAGE , REQUIRED, STATIC  , OTHER, NPlayerData, Stats, Lives, &NPlayerStats_fields),
    PB_FIELD(  8, MESSAGE , REQUIRED, STATIC  , OTHER, NPlayerData, Totals, Stats, &NPlayerStats_fields),
    PB_FIELD(  9, UINT32  , REQUIRED, STATIC  , OTHER, NPlayerData, MaxHealth, Totals, 0),
    PB_FIELD( 10, UINT32  , REQUIRED, STATIC  , OTHER, NPlayerData, LastMission, MaxHealth, 0),
    PB_FIELD( 11, UINT32  , REQUIRED, STATIC  , OTHER, NPlayerData, UID, LastMission, 0),
    PB_LAST_FIELD
};
