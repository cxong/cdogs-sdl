...
/* Generated by nanopb-0.3.0 at Wed Mar 16 00:21:20 2016. */
...
const pb_field_t NPlayerData_fields[11] = {
    ...
    PB_FIELD(  2, INT32   , REQUIRED, STATIC  , OTHER, NPlayerData, Face, Name, 0),
    PB_FIELD(  3, MESSAGE , REQUIRED, STATIC  , OTHER, NPlayerData, Colors, Face, &NCharColors_fields),
