 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(NPlayerData, Looks) < 65536 && pb_membersize(NAddMapObject, Pos) < 65536 && pb_membersize(NActorAdd, FullPos) < 65536 && pb_membersize(NActorMove, Pos) < 65536 && pb_membersize(NAddPickup, Pos) < 65536 && pb_membersize(NAddBullet, MuzzlePos) < 65536 && pb_membersize(NExploreTile, Tile) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_NRequestPlayers_NCmd_NNewPlayers_NClientId_NCampaignDef_NPlayerData_NPlayerData_CharLooks_NObjectiveCount_NAddPlayers_NAddMapObject_NScore_NVec2i_NActorAdd_NActorMove_NActorState_NActorDir_NAddPickup_NAddBullet_NExploreTile_NObjectiveUpdate)
#endif
