...
/* Generated by nanopb-0.3.0 at Sat Jun 20 21:59:31 2015. */
...
const pb_field_t NAddPlayers_fields[3] = {
    ...
    PB_FIELD(  2, MESSAGE , REPEATED, STATIC  , OTHER, NAddPlayers, PlayerDatas, ClientId, &NPlayerData_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(NPlayerData, Looks) < 65536 && pb_membersize(NAddPlayers, PlayerDatas[0]) < 65536 && pb_membersize(NAddMapObject, Pos) < 65536 && pb_membersize(NActorAdd, FullPos) < 65536 && pb_membersize(NActorMove, Pos) < 65536 && pb_membersize(NAddPickup, Pos) < 65536 && pb_membersize(NAddBullet, MuzzlePos) < 65536 && pb_membersize(NExploreTile, Tile) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_NRequestPlayers_NCmd_NClientId_NCampaignDef_NCharLooks_NPlayerData_NObjectiveCount_NAddPlayers_NAddMapObject_NScore_NVec2i_NActorAdd_NActorMove_NActorState_NActorDir_NActorHeal_NActorAddAmmo_NAddPickup_NRemovePickup_NAddBullet_NExploreTile_NObjectiveUpdate)
#endif
