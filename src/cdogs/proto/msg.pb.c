...
/* Generated by nanopb-0.3.0 at Mon Aug 03 23:05:19 2015. */
...
const pb_field_t NActorMelee_fields[6] = {
    ...
    PB_FIELD(  3, BOOL    , REQUIRED, STATIC  , OTHER, NActorMelee, HitSounds, BulletClass, 0),
    PB_FIELD(  4, INT32   , REQUIRED, STATIC  , OTHER, NActorMelee, TargetKind, HitSounds, 0),
...
const pb_field_t NGunFire_fields[7] = {
    PB_FIELD(  1, INT32   , REQUIRED, STATIC  , FIRST, NGunFire, PlayerUID, PlayerUID, &NGunFire_PlayerUID_default),
    PB_FIELD(  2, STRING  , REQUIRED, STATIC  , OTHER, NGunFire, Gun, PlayerUID, 0),
    PB_FIELD(  3, MESSAGE , REQUIRED, STATIC  , OTHER, NGunFire, MuzzleFullPos, Gun, &NVec2i_fields),
    PB_FIELD(  4, INT32   , REQUIRED, STATIC  , OTHER, NGunFire, Z, MuzzleFullPos, 0),
...
const pb_field_t NAddBullet_fields[9] = {
    ...
    PB_FIELD(  7, INT32   , REQUIRED, STATIC  , OTHER, NAddBullet, PlayerUID, Flags, 0),
    PB_FIELD(  8, INT32   , REQUIRED, STATIC  , OTHER, NAddBullet, UID, PlayerUID, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(NPlayerData, Looks) < 65536 && pb_membersize(NAddMapObject, Pos) < 65536 && pb_membersize(NSound, Pos) < 65536 && pb_membersize(NActorAdd, FullPos) < 65536 && pb_membersize(NActorMove, Pos) < 65536 && pb_membersize(NActorMove, MoveVel) < 65536 && pb_membersize(NActorSlide, Vel) < 65536 && pb_membersize(NActorImpulse, Vel) < 65536 && pb_membersize(NActorImpulse, Pos) < 65536 && pb_membersize(NAddPickup, Pos) < 65536 && pb_membersize(NGunReload, FullPos) < 65536 && pb_membersize(NGunFire, MuzzleFullPos) < 65536 && pb_membersize(NAddBullet, MuzzlePos) < 65536 && pb_membersize(NTrigger, Tile) < 65536 && pb_membersize(NExploreTiles, Runs[0]) < 65536 && pb_membersize(NExploreTiles_Run, Tile) < 65536 && pb_membersize(NAddKeys, Pos) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_NRequestPlayers_NCmd_NClientId_NCampaignDef_NCharLooks_NPlayerData_NAddMapObject_NScore_NSound_NVec2i_NActorAdd_NActorMove_NActorState_NActorDir_NActorSlide_NActorImpulse_NActorSwitchGun_NActorPickupAll_NActorReplaceGun_NActorHeal_NActorAddAmmo_NActorUseAmmo_NActorDie_NActorMelee_NAddPickup_NRemovePickup_NGunReload_NGunFire_NGunState_NAddBullet_NTrigger_NExploreTiles_NExploreTiles_Run_NRescueCharacter_NObjectiveUpdate_NAddKeys_NMissionComplete)
#endif
