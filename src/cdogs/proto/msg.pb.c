...
/* Generated by nanopb-0.3.0 at Tue Jun 30 23:55:19 2015. */
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(NPlayerData, Looks) < 65536 && pb_membersize(NAddPlayers, PlayerDatas[0]) < 65536 && pb_membersize(NAddMapObject, Pos) < 65536 && pb_membersize(NSound, Pos) < 65536 && pb_membersize(NActorAdd, FullPos) < 65536 && pb_membersize(NActorMove, Pos) < 65536 && pb_membersize(NAddPickup, Pos) < 65536 && pb_membersize(NAddBullet, MuzzlePos) < 65536 && pb_membersize(NTrigger, Tile) < 65536 && pb_membersize(NExploreTile, Tile) < 65536 && pb_membersize(NAddKeys, Pos) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_NRequestPlayers_NCmd_NClientId_NCampaignDef_NCharLooks_NPlayerData_NObjectiveCount_NAddPlayers_NAddMapObject_NScore_NSound_NVec2i_NActorAdd_NActorMove_NActorState_NActorDir_NActorSwitchGun_NActorPickupAll_NActorReplaceGun_NActorHeal_NActorAddAmmo_NActorUseAmmo_NAddPickup_NRemovePickup_NAddBullet_NTrigger_NExploreTile_NRescueCharacter_NObjectiveUpdate_NAddKeys_NMissionComplete)
#endif
