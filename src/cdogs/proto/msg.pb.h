...
#define NActorHit_init_default                   {0, -1, -1, 0, 0, NVec2i_init_default, 0}
...
#define NBulletBounce_init_default               {0, 0, 0, NVec2i_init_default, NVec2i_init_default, NVec2i_init_default, 0}
...
#define NActorHit_init_zero                      {0, 0, 0, 0, 0, NVec2i_init_zero, 0}
...
#define NBulletBounce_init_zero                  {0, 0, 0, NVec2i_init_zero, NVec2i_init_zero, NVec2i_init_zero, 0}
...
extern const pb_field_t NBulletBounce_fields[8];
