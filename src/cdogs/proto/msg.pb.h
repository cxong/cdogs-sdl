...
extern const int32_t NActorHeal_PlayerId_default;
extern const int32_t NActorAddAmmo_PlayerId_default;
...
#define NActorAddAmmo_PlayerId_tag               2
...
#define NActorHeal_PlayerId_tag                  2
