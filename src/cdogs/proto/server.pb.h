...
/* Enum definitions */
/* Struct definitions */
typedef struct _NetMsgActorDir {
    int32_t UID;
    int32_t Dir;
} NetMsgActorDir;

typedef struct _NetMsgActorState {
    int32_t UID;
    int32_t State;
} NetMsgActorState;
...
typedef struct _NetMsgAddBullet {
    char BulletClass[128];
    NetMsgVec2i MuzzlePos;
...
#define NetMsgActorState_init_default            {0, 0}
#define NetMsgActorDir_init_default              {0, 0}
#define NetMsgAddBullet_init_default             {"", NetMsgVec2i_init_default, 0, 0, 0, 0, 0, 0}
...
#define NetMsgActorState_init_zero               {0, 0}
#define NetMsgActorDir_init_zero                 {0, 0}
#define NetMsgAddBullet_init_zero                {"", NetMsgVec2i_init_zero, 0, 0, 0, 0, 0, 0}

/* Field tags (for use in manual encoding/decoding) */
#define NetMsgActorDir_UID_tag                   1
#define NetMsgActorDir_Dir_tag                   2
#define NetMsgActorState_UID_tag                 1
#define NetMsgActorState_State_tag               2
...
#define NetMsgAddBullet_BulletClass_tag          1
#define NetMsgAddBullet_MuzzlePos_tag            2
#define NetMsgAddBullet_MuzzleHeight_tag         3
#define NetMsgAddBullet_Angle_tag                4
#define NetMsgAddBullet_Elevation_tag            5
#define NetMsgAddBullet_Flags_tag                6
#define NetMsgAddBullet_PlayerIndex_tag          7
#define NetMsgAddBullet_UID_tag                  8
...
extern const pb_field_t NetMsgActorState_fields[3];
extern const pb_field_t NetMsgActorDir_fields[3];
extern const pb_field_t NetMsgAddBullet_fields[9];
...
#define NetMsgActorState_size                    22
#define NetMsgActorDir_size                      22
#define NetMsgAddBullet_size                     215
